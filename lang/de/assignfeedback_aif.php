...
$string['enableexpertmode_text'] = 'Wenn aktiviert, wird in den Aufgabeneinstellungen eine Schaltfläche „Expertenmodus-Vorlage" angezeigt, mit der Lehrkräfte die vollständige Prompt-Vorlage mit allen Platzhaltern direkt verwenden können.';$string['enablepromptfile'] = 'Prompt-Datei-Upload aktivieren';
$string['enablepromptfile_text'] = 'Wenn aktiviert, können Lehrkräfte in den Aufgabeneinstellungen eine Textdatei als Prompt hochladen.';$string['err_retrievingfeedback'] = 'Fehler beim Abrufen des Feedbacks vom KI-Werkzeug: {$a}';
