...
$string['applyrubricgrades'] = 'KI-Bewertung in das Bewertungsraster übernehmen';
$string['applyrubricgrades_help'] = 'Nur für Aufgaben, die mit einem Bewertungsraster (Rubrik) bewertet werden und bei denen der Bewertungsworkflow aktiviert ist. Die KI liefert zusätzlich eine strukturierte Bewertung (Stufe und Anmerkung pro Kriterium). Diese wird in das Bewertungsraster eingetragen und die Bewertung bleibt im Workflow-Status "In Überprüfung", sodass eine Lehrkraft jede Bewertung vor der Freigabe prüft und bestätigt. Kann die Bewertung nicht eindeutig dem Bewertungsraster zugeordnet werden, wird nur das Text-Feedback gespeichert.';
$string['applyrubricgrades_norubricnotice'] = 'Diese Aufgabe verwendet noch kein Bewertungsraster mit Kriterien. Wählen Sie als Bewertungsmethode "Bewertungsraster" und definieren Sie es unter "Erweiterte Bewertung", sonst wird nur das Text-Feedback gespeichert.';
...
$string['privacy:metadata:core_grading'] = 'Wenn aktiviert, wird die KI-Bewertung im Bewertungsraster der Aufgabe gespeichert.';
...
$string['rubricapplied'] = 'Die KI-Bewertung wurde in das Bewertungsraster übernommen. Die Bewertung ist in Überprüfung und muss von einer Lehrkraft bestätigt werden.';
$string['rubricapplyskipped_alreadygraded'] = 'KI-Bewertung nicht übernommen: Die Bewertung befindet sich bereits in einem Status nach "In Überprüfung".';
$string['rubricapplyskipped_gradingdisabled'] = 'KI-Bewertung nicht übernommen: Die Bewertung ist für diese/n Nutzer/in gesperrt oder überschrieben.';
