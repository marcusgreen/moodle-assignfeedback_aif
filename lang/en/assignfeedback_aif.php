...
$string['displaytostudent'] = 'Display to student';
$string['displaytostudent_help'] = 'Display the AI Feedback to the student';
$string['enabled'] = "Enabled";
$string['enabled_help'] = 'Enable the AI Feedback plugin, only works for onlinetext submissiont type';
