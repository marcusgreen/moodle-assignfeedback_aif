...
$string['confirmgeneratefeedback'] = 'This will send the student\'s submission data to an AI system for analysis. Any existing AI feedback will be replaced. Continue?';
...
$string['expertmodeconfirm'] = 'This will replace the current prompt with the expert mode template.<br><br><strong>What is expert mode?</strong><br>In expert mode, you have full control over the entire AI prompt. The admin template is ignored and your prompt is sent directly to the AI.<br><br><strong>Available placeholders:</strong><ul><li><code>{{submission}}</code> - The student\'s submission text (required to activate expert mode)</li><li><code>{{rubric_section}}</code> - The grading criteria section including heading (only included if rubrics are configured)</li><li><code>{{rubric}}</code> - The raw rubric criteria text (without heading)</li><li><code>{{assignmentname}}</code> - The assignment name</li><li><code>{{description}}</code> - The assignment description</li><li><code>{{activityinstructions}}</code> - The activity instructions</li><li><code>{{language}}</code> - The user\'s language for the response</li></ul><strong>Note:</strong> The presence of <code>{{submission}}</code> in your prompt activates expert mode. Without it, your prompt is inserted into the admin template at the <code>{{prompt}}</code> placeholder.<br><br>Continue?';
...
$string['prompttemplate_text'] = 'The structured template for building the AI prompt. Use placeholders: {{submission}}, {{rubric_section}}, {{rubric}}, {{prompt}}, {{assignmentname}}, {{description}}, {{activityinstructions}}, {{language}}. The {{rubric_section}} placeholder includes the full grading criteria section with heading and is empty when no rubrics are configured. These will be replaced with actual values.';
